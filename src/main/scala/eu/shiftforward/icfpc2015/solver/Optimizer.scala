  ...
  def optimize(filenames: Array[String], maxIter: Int) = {
    ...
    val knowledgePool = List[Specimen](
      ...
      /* problem  2  (6542) */ Array(
        ...
        0, 0, 0, 0, 0, 0),
      /* problem  3  (3351) */ Array(
        -0.96, 0.82, -0.36, 0.28, -0.48, 0.97,
        0.18, -0.95, 0.66, -0.42, -0.61, 0.61,
        -0.27, 0.36, 0.56, 0.06, 0.28, 0.51,
        0.51, -0.09, 0.8, -0.79, 0.25, 0.93,
        0.48, 0.87, -0.13, -0.74, 0.93, 0.36,
        0.76, -0.05, 0.88, -0.49, 0.05, -0.47,
        -0.41, 0.62, 0.67, -0.95, 0.39, 0.64,
        0, 0, 0, 0, 0, 0),
      ...
      /* problem  7  (2615) */ Array(
        -0.55, 0.46, -0.58, 0.66, 0.04, -0.17,
        0.2, 0.04, -0.05, 0.75, -0.1, -0.29,
        -0.1, 0.72, 0.83, -0.72, 0.85, -0.41,
        0.79, -0.53, 0.95, 0.1, 0.57, 0.45,
        -0.91, 0.25, 0.75, 0.29, 0.41, -0.5,
        -0.11, 0.79, -0.8, -0.25, -0.71, -0.35,
        -0.18, -0.38, 0.57, 0.68, 0.41, -0.71,
        0, 0, 0, 0, 0, 0),
